...
<table class="table table-bordered">
    ...
    <td width="150">Name</td><td>
        <?php echo inputan('text', 'nama','col-sm-4','Name ..', 1, '','');?>
    </td>
	
    </tr>
	    <td width="150">position</td><td>
        <div class="col-sm-3">
        <?php echo form_dropdown('jabatan',$jabatan,'',$class3);?>
        </div>
		</td>
    ...
    <td width="150">User Login</td><td>
        <?php echo inputan('text', 'userlogin','col-sm-4','User Login ..', 1, '','');?>
    </td>
    </tr>
    ...
    <td width="150">Divisi</td><td>
        <?php echo buatcombo('divisi', 'tm_divisi', 'col-sm-3', 'snamadivisi', 'nkddivisi', '', '');?>
    </td>
    </tr>
	<tr>
    ...
    <td width="150">Status Active</td><td>
        <div class="col-sm-3">
        <?php echo form_dropdown('status',$active,'',$class);?>
        </div>
    </td>
    </tr>
