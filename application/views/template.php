...
<html lang="en">
  ...
  <body>
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><?php echo anchor('user/profile',"<i class='fa fa-cogs'></i> Account");?></li>
	...
	<!-------footer web --------------------------->
      ...
      <hr>
      <p align='center' style="font-weight: bold;" >&copy; WebTask V 0.1 | PT.HI-LEX INDONESIA 2016</p>
      <!--
    ...
    <!-- Include all compiled plugins (below), or include individual files as needed -->
                                ...
                                <!--test sticky header -->
	    <script src="<?php echo base_url()?>StickyTableHeaders/js/jquery.stickyheader.js"></script>
