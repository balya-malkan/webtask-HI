...
<table class="table table-bordered">
    ...
    <td width="150">Activity Name</td><td>
        <?php echo inputan('text', 'desc','col-sm-4','Activity Name ..', 1, $r['sDesc'],'');?>
    </td>
    </tr>
 
     <tr>
    <td width="150">Activity Date<td>
        <?php echo inputan('text', 'tanggal','col-sm-4','Activity Date ..', 0, $r['dDate'],array('id'=>'datepicker'));?>
    </td>
    </tr>
	
	<tr>
    <td width="150">Activity Time</td><td>
        <?php echo inputan('time', 'waktu','col-sm-4','Activity Time ..', 1, $r['swaktu'],'');?>
    ...
    <td width="150">Location</td><td>
        <?php echo inputan('text', 'lokasi','col-sm-4','Location ..', 1,  $r['slocation'],'');?>
    </td>
    </tr>
